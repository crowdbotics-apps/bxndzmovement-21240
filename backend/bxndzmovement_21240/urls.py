"""bxndzmovement_21240 URL Configuration
...
admin.site.site_header = "bxndzmovement"
admin.site.site_title = "bxndzmovement Admin Portal"
admin.site.index_title = "bxndzmovement Admin"

# swagger
api_info = openapi.Info(
    title="bxndzmovement API",
    default_version="v1",
    description="API documentation for bxndzmovement App",
)
